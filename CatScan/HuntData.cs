...
public static partial class HuntData
{
    ...
    // -- Occult Crescent
        ...
        // XXX: Just track every basic mob for now

        {1252, Occult_Zone("South Horn",
            KC("Crescent Bandersnatch"),
            KC("Crescent Garula"),
            KC("Crescent Flying Lizard"),
            KC("Crescent Chaochu"),
            KC("Crescent Gaelicat"),
            KC("Crescent Snapweed"),
            KC("Crescent Leshy"),
            KC("Crescent Tormentor"),
            KC("Crescent Marolith"),
            KC("Crescent Fan"),
            KC("Animated Doll"),
            KC("Crescent Goobbue"),
            KC("Crescent Karlabos"),
            KC("Crescent Cetus"),
            KC("Crescent Petalodite"),
            KC("Crescent Golem"),
            KC("Crescent Uragnite"),
            KC("Crescent Catoblepas"),
            KC("Crescent Meraevis"),
            KC("Crescent Brachiosaur"),
            KC("Crescent Triceratops"),
            KC("Crescent Foper"),
            KC("Crescent Rosebear"),
            KC("Crescent Harpuia"),
            KC("Crescent Aetherscab"),
            KC("Crescent Taurus"),
            KC("Menacing Dahak"),
            KC("Crescent Byblos"),
            KC("Crescent Echos"),
            KC("Crescent Panther"),
            KC("Crescent Monk"),
            KC("Crescent Blood Demon"),
            KC("Crescent Headstone"),
            KC("Crescent Blackguard"),
            KC("Crescent Bachelor"),
            KC("Crescent Demon Pawn"),
            KC("Crescent Lion Statant"),
            KC("Occult Sculpture"),
            KC("Crescent Dirty Eye"),
            KC("Crescent Zaghnal"),
            KC("Crescent Flame"),
            KC("Crescent Apa"),
            KC("Crescent Zaratan"),
            KC("Lesser Cry of Havoc"),
            KC("Crescent Haagenti"),
            KC("Crescent Zangbeto"),
            KC("Crescent Foobar"),
            KC("Crescent Diplocaulus"),
            KC("Crescent Void Viper"),
            KC("Crescent Claw"),
            KC("Crescent Collagen"),
            KC("Crescent Inkstain"),
            KC("Arcapetrified Netzach"),
            KC("Crescent Chimera"),
            KC("Crescent Satana"),
            KC("Occult Golem"),
            KC("Occult Isleblazer"),
            KC("Crescent Zirnitra"),
            KC("Crescent Armor"),
            KC("Crescent Ghost"),
            KC("Crescent Caoineag"),
            KC("Crescent Gourmand"),
            KC("Crescent Troubadour"),
            KC("Crescent Geshunpest"),
            KC("Crescent Dullahan")
        )}
    };
